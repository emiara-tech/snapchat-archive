		...
		<div class="container container-narrow">
			<header class="page-header">
				...
				<p class="page-subtitle">
					...
					JSON. Media files are not packaged — this tool focuses on structured
			...
			<div class="export-info card">
				<h3>Media files</h3>
				<p>
					This export covers structured data only. Photo and video files from
					your archive are not packaged — the JSON output contains the metadata
			...
			<div v-if="exportComplete" class="export-success card">
				...
				<p>
					The file contains only data already parsed in this browser session.
				</p>
			</div>
